...
write.xlsx(fPTS3, file = "/data/scratch/Genotype_DAC/fPTS3.xlsx")
...
write.xlsx(PT5, file = "/data/scratch/Genotype_DAC/PT5.xlsx")
...
write.xlsx(EC1, file = "/data/scratch/Genotype_DAC/EC1.xlsx")
...
write.xlsx(EC2, file = "/data/scratch/Genotype_DAC/EC2.xlsx")
...
write.xlsx(DCT1, file = "/data/scratch/Genotype_DAC/DCT1.xlsx")
...
write.xlsx(DCT2, file = "/data/scratch/Genotype_DAC/DCT2.xlsx")
...
write.xlsx(cTAL, file = "/data/scratch/Genotype_DAC/cTAL.xlsx")
